...
class VectorContext(
     ...
     * ACC_CONSTRUCTOR. Allocate a Method without running its constructor and copy Executable state.
     */
    private fun asSyntheticMethod(clinit: Executable): Executable {
        ...
        return runCatching {
            ...
            .onFailure {
                Log.w(
                    TAG,
                    "Cannot present <clinit> of ${clinit.declaringClass.name} as a Method",
                    it,
                )
            }
            .getOrDefault(clinit)
    ...
    /** Locate <clinit> from ART method layout without triggering class initialization. */
